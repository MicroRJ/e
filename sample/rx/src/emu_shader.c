...
rxShader
rxShaderCreateFromBytecode(int flags, char const *label, size_t hlsl_length, void *hlsl_memory)
{
...
void
rlShaderIni(
rxShader *shader, rxShaderConfig *config)
{
